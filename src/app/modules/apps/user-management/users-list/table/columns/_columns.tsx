...
import {
  UserRoleCell
} from "@/app/modules/apps/user-management/users-list/table/columns/UserRoleCell";
import {
  UserGenderCell
} from "@/app/modules/apps/user-management/users-list/table/columns/UserGenderCell";
