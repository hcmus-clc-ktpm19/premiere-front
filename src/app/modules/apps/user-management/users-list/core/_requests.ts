...
const enableCustomerCreditCard = (userCreditCardNumber: string): Promise<void> => {
  return axios.get(`${CREDIT_CARD_URL}/enable/${userCreditCardNumber}`).then(() => {
  });
};
