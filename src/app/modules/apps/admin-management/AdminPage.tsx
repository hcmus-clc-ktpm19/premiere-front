...
import { EmployeesListWrapper } from '@/app/modules/apps/admin-management/employees-list/ListOfEmployees';
import ListOfTransactions from '@/app/modules/apps/admin-management/transactions-list/ListOfTransactions';
import TransactionStatistics from '@/app/modules/apps/admin-management/transactions-list/TransactionStatistics';
