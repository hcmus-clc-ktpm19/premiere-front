...
import { TransactionCriteriaDtoCustom } from '@/app/modules/apps/admin-management/transactions-list/core/_dtos';
      ...
      <div className='row g-6 g-xl-9'>
        {transactionsAreFetching ? (
          ...
          res?.payload
            .filter(
              (item: TransactionDto) =>
                item.senderCreditCardNumber.indexOf(searchTerm.toLowerCase() || '') > -1 ||
                item.receiverCreditCardNumber.indexOf(searchTerm.toLowerCase() || '') > -1
            )
