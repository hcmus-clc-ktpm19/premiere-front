...
const ReminderPaymentModal: FC<Props> = ({
  isShow,
  setIsShowModal,
  reminder,
  setPaymentSuccess,
    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        const loanReminderMessageDto: LoanReminderMessageDto = {
          ...
          message: `${currentUser?.lastName + ' ' + currentUser?.firstName} has paid your debt of ${
            reminder.transferAmount
          } VND`,
            ...
            <div className='modal-body scroll-y mx-5 mx-xl-15 my-7'>
              ...
              >
                <div className='mb-5 bg-light-info p-8 rounded'>
                  <div className='text-info'>Enter OTP sent to your email</div>
                </div>
